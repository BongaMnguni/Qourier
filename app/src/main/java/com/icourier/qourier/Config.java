...
public class Config {
    ...
    //Retrive messages
    public static final String URL_GET_ALL_MESSAGES = "http://mydm.co.za/Icourier/RetrieveMessages.php";
    public static final String TAG_MESSAGE_TIME = "time";
    public static final String TAG_MESSAGE_NAME = "name";
    public static final String TAG_MESSAGE_SUBJECT = "subject";
